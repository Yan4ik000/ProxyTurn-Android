...
<br>
  ...
  <a href="https://github.com/amurcanov/proxy-turn-vk-android/stargazers">
    <img src="https://img.shields.io/github/stars/Yan4ik000/ProxyTurn-Android?style=for-the-badge&logo=github&color=ffca28&labelColor=24292e" alt="Stars">
  </a>
</div>
<br>
...
<img width="1000" height="724" alt="0808" src="https://github.com/user-attachments/assets/b0456612-dffe-45e7-a5f5-8d87bdeda112" />
...
- [IGOR7276/proxy-turn-vk-windows](https://github.com/IGOR7276/proxy-turn-vk-windows) - Альтернативный вариант для Windows
...
1. Приложение запускает нативный Go-клиент `libclient.so` и передаёт ему адрес VPS, VK-хеши звонка, пароль туннеля и количество потоков (вместо фиксированного количества потоков можно поставить динамический режим)
...
1. Скачайте актуальный `APK` со **[страницы релизов](https://github.com/Yan4ik000/ProxyTurn-Android/releases)**.
2. Установите приложение на Android-смартфон.
3. Подготовьте айпи, логин, пароль/ssh ключ от имеющегося VPS.
...
5. Откройте **WDTT** и на главной странице нажмите на иконку облака (в правом верхнем крае).
6. Попав на вкладку деплоя - введите IP/домен VPS, SSH-логин, пароль/ssh ключ в **«Секретах»** и SSH-порт.
...
9. Во вкладке **«Туннель»** укажите IP/домен сервера, VK-хеши и пароль подключения (при включенном фиксированной режиме мощности - также и количество потоков)
...
Приложение проверяет **GitHub releases** репозитория [Yan4ik000/ProxyTurn-Android](https://github.com/Yan4ik000/ProxyTurn-Android), умеет показывать диалог новой версии и открывать страницу релиза в браузере. Проверка выполняется при запуске и периодически в фоне.
...
Copyright (C) 2026 amurcanov
Copyright (C) 2026 Yan4ik000
